...
<template>
    ...
    <div class="relative flex flex-col sm:flex sm:justify-center sm:items-center min-h-screen bg-dots-darker bg-center bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 selection:bg-red-500 selection:text-white">
        <div v-if="canLogin"
             class="absolute flex items-center sm:fixed sm:top-0 sm:right-0 p-6 text-right space-x-4">
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="text-slate-200">
                <!--{{ $t("cart.cartCount", {itemCount: 8, exCount: 1}) }}-->
                <!--<span v-html="$t('moderatorGreetings', { name: 'İbrahim' })"/>-->

                <!-- <p>{{ $t("car", 2) }}</p>

                <p> {{ $t("cart.cartCount", { itemCount: $t("item", 8) }) }} </p>-->
